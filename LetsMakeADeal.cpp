...
void LetsMakeADeal::usage()
{
   ...
   cout << "Usage: ./simulation -d <doors> -u <user selected door> -g <games> -s <stay/swap>"
	<< endl;
   cout << "-d : the total number of doors in the game" << endl;
   cout << "-u : the user selected door" << endl;
